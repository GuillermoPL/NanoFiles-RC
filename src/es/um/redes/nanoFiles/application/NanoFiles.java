...
public class NanoFiles {
	public static boolean NANOFILES_VERBOSE_MODE = true;
	public static final String DEFAULT_SHARED_DIRNAME = "nf-shared";
	/**
	 * Identificador único para cada grupo de prácticas. DONE: Establecer a un valor
	 * que combine los DNIs de ambos miembros del grupo de prácticas.
	 */
	public static final String PROTOCOL_ID = "415353454D";
	...
	public static void main(String[] args) {
		...
		if (testModeUDP) {
			...
			controller.getNFControllerLogicDir().getDirectoryConnector().close(); //Añadido, si no, el socket no se cierra (realmente Java si lo cierra, pero por ser robustos...)........
		}
	}
}
